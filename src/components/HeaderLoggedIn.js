			...
			<div className="container d-flex align-items-center">
				<h1 className="logo me-auto"><a href="/">Joseph W Borders</a></h1>
					<nav id="navbar" className="navbar">
						<ul>
							<li><a className="nav-link scrollto active" href="/welcome">Home</a></li>
								...
								<li className="dropdown"><a href=""><span>Manage Account</span> <i className="bi bi-chevron-down"></i></a>
									<ul>
										<li><a href="">Edit Account Details</a></li>
										<li><a href="/archive">View Archived Proposals</a></li>
										<li><a href="/createproposal">Create New Proposal</a></li>
									</ul>
								</li>
								<li><a onClick={handleLogout} className="getstarted scrollto" href="/">Logout</a></li>
							</ul>
